...
| global.image.registry        | string | `"docker.steadybit.io"`                                                                                                                                                                      | The container registry to use for all platform images. Can be overridden per image by including a registry in image.name.                                                    |
| image.name                   | string | `"steadybit/platform"`                                                                                                                                                                       | The container image to use of the steadybit platform. May contain a registry prefix, in which case global.image.registry is ignored.                                         |
