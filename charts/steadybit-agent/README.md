...
| serviceAccount.eksRoleArn                   | string | `nil`                                   | The arn of the IAM role when using the agent with agent.mode=aws and you want to use Web identity token from AWS STS. https://docs.aws.amazon.com/eks/latest/userguide/specify-service-account-role.html                                                                                                                                   |
